...
- 下载地址：[kaitify](https://registry.npmmirror.com/@kaitify/core/download/@kaitify/core-0.0.3-beta.3.tgz)
...
```html
<!-- 引入固定版本的kaitify -->
<script src="https://unpkg.com/@kaitify/core@0.0.3-beta.3/lib/kaitify-core.umd.js"></script>
<!-- 始终引入最新的kaitify -->
